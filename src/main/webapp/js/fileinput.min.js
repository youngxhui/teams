...
!function (e) {
    ...
    var i = function (e) {
            ...
            data: {}, init: function (e) {
                ...
                var n = r.config[i], l = N("caption", n) ? n.caption : "", o = N("width", n) ? n.width : "auto",
                    s = N("url", n) ? n.url : !1, d = N("key", n) ? n.key : null, p = s === !1 && a,
                    c = r.isDelete ? r.actions(!1, !0, p, s, d, i) : "", f = r.footer.repl("{actions}", c);
        ...
        j = {
            ...
            actionDelete: y,
            actionUpload: E
        }, A = {generic: $, html: T, image: F, text: k, video: D, audio: I, flash: P, object: S, other: U},
    ...
    V.prototype = {
        constructor: V, init: function (a) {
            ...
            var i = this, t = i.minFileCount > 1 ? i.filePlural : i.fileSingle,
                a = i.msgFilesTooLess.repl("{n}", i.minFileCount).repl("{files}", t), r = i.$errorContainer;
            ...
            var n = this, l = a === !1 ? "" : ' data-url="' + a + '"', o = r === !1 ? "" : ' data-key="' + r + '"',
                s = n.getLayoutTemplate("actionDelete"), d = "", p = n.getLayoutTemplate("actions"),
                c = n.otherActionButtons.repl("{dataKey}", o), f = n.fileActionSettings,
            ...
            i.$preview.find(".kv-file-remove").each(function () {
                var n, l, o, d, p = e(this), c = p.closest(".file-preview-frame"), f = t.data[i.id],
                    u = p.data("url") || i.deleteUrl, v = p.data("key"), h = {id: p.attr("id"), key: v, extra: o};
            ...
            var l, o, d, p, c, f, u, v, h, m, g = this, w = g.getFileStack().length, b = new FormData,
                x = g.previewInitId + "-" + i, C = e("#" + x + ":not(.file-preview-initial)"),
                y = C.find(".kv-file-upload"), E = C.find(".kv-file-remove"), $ = C.find(".file-upload-indicator"),
                T = g.fileActionSettings, F = g.filestack.length > 0 || !e.isEmptyObject(g.uploadExtraData),
                k = {id: x, index: i};
            ...
            var i, t, r, n, l, o, d, p, c = this, f = c.filestack, u = f.length,
                v = c.filestack.length > 0 || !e.isEmptyObject(c.uploadExtraData), h = {};
            c.formdata = new FormData, 0 !== u && v && !c.abort(h) && (i = c.fileActionSettings, t = function (t, a, r) {
                ...
                var t = e("#" + c.previewInitId + "-" + i + ":not(.file-preview-initial)"),
                    a = t.find(".kv-file-upload"), r = t.find(".kv-file-delete");
            ...
            if (this.showPreview) {
                var r = this, n = H.createObjectURL(i), l = e("#" + t), o = r.previewSettings.other,
                    s = r.renderFileFooter(i.name, o.width), d = r.getPreviewTemplate("other"),
                    p = t.slice(t.lastIndexOf("-") + 1), c = "";
            ...
            if (this.showPreview) {
                var r, n, l, o, s = this, d = s.parseFileType(e), p = s.slug(e.name), c = s.allowedPreviewTypes,
                    f = s.allowedPreviewMimeTypes, u = s.getPreviewTemplate(d),
                    v = N(d, s.previewSettings) ? s.previewSettings[d] : O[d], h = parseInt(s.wrapTextLength, 10),
                    m = s.wrapIndicator, g = c.indexOf(d) >= 0, w = z(f) || !z(f) && N(e.type, f),
                    b = s.renderFileFooter(p, v.width), x = "", C = t.slice(t.lastIndexOf("-") + 1);
            ...
            function t(e) {
                ...
                var m, g, w, b, x, C, y = v + e, E = c + "-" + y, $ = i[e], T = a.slug($.name), F = ($.size || 0) / 1e3,
                    k = "", D = H.createObjectURL($), I = 0, P = a.allowedFileTypes, S = z(P) ? "" : P.join(", "),
                    U = a.allowedFileExtensions, j = z(U) ? "" : U.join(", ");
            ...
            var a = this, r = a.$element, n = a.$preview, l = a.reader, o = a.$previewContainer, s = a.$previewStatus,
                d = a.msgLoading, p = a.msgProgress, c = a.previewInitId, f = i.length, u = a.fileTypeSettings,
                v = a.filestack.length, h = function (t, r, n, l) {
            ...
            var i = this, a = i.msgSelected, r = i.$element, n = i.getFileStack(),
                l = r.val() || n.length && n[0].name || "", o = i.slug(l), s = i.isUploadable ? n.length : e,
                d = t.count(i.id) + s, p = s > 1 ? a.repl("{n}", d) : o;
            ...
            var n, l, o, s, d = a.$preview, p = arguments.length > 1,
                c = p ? i.originalEvent.dataTransfer.files : r.get(0).files, f = z(r.attr("multiple")), u = 0, v = 0,
                h = a.filestack.length, m = a.isUploadable, g = function (i, t, r, n) {
            ...
            var e = this, i = e.isUploadable && e.dropZoneEnabled ? " file-drop-zone" : "",
